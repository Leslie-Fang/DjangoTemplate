...
SECRET_KEY = 'p74p5y0-9kzr9p-ci0(b*b_a7whdn3y-%i*iy#w1(palqfg*3&'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['150.95.148.104', 'localhost', '127.0.0.1','47.91.245.251']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'login', 'templates'),
                 os.path.join(BASE_DIR, 'usersDetail', 'templates'),
                 BASE_DIR+'/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
